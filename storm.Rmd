...
```{r}
# Update aggr() to ignore already proper strings
# Remember that ifelse() is vectorized while if() is not
...
# cc<-matrix(c(1,2,3,4),ncol=2)
# cc<-data.frame(cc)
# cc$type=c("Winter Weather","Winter")
# cc
# aggr(cc,"winter","summer")
## OK, it works
...
as dropping 2011 didn't change the event type comparison picture.
